    ...
    case 0: // Designing
      return (
        <div className="relative w-full h-full bg-[#fdfbf7] flex flex-col items-center justify-center p-6 min-h-[250px] md:min-h-0 border-b md:border-b-0 md:border-r border-[#ebdcc6]">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(#cca09d_1px,transparent_1px)] [background-size:16px_16px] opacity-15" />
          ...
          <div className="relative w-32 h-40 flex items-center justify-center border border-[#ebdcc6] bg-white p-4 shadow-inner rounded-sm overflow-hidden">
            ...
            <svg width="80" height="100" viewBox="0 0 100 120" fill="none" stroke="#9c6d68" strokeWidth="1.2" className="opacity-80">
              <path d="M40 20 L60 20 L65 35 L35 35 Z" />
              <rect x="33" y="38" width="34" height="4" rx="1" fill="#9c6d68"/ >
            ...
            <div className="absolute top-1/4 left-1/4 animate-[pencil-draw_5s_infinite_ease-in-out] pointer-events-none">
              <Pencil size={18} className="text-[#9c6d68] drop-shadow-sm" strokeWidth={1.5} />
            </div>
          </div>
          <span className="text-[9px] uppercase tracking-[0.25em] text-[#9c6d68] font-bold mt-4 animate-pulse">Drafting Couture Sketches...</span>
        </div>
      );
    case 1: // Embroidery
      return (
        <div className="relative w-full h-full bg-[#fdfbf7] flex flex-col items-center justify-center p-6 min-h-[250px] md:min-h-0 border-b md:border-b-0 md:border-r border-[#ebdcc6]">
          ...
          <div className="relative w-36 h-36 flex items-center justify-center rounded-full border-4 border-[#ebdcc6] bg-white shadow-md">
            <div className="absolute -top-3 w-5 h-2.5 bg-[#ebdcc6] border border-[#9c6d68] rounded-sm" />
            <div className="absolute inset-2 rounded-full bg-[radial-gradient(#cca09d_0.75px,transparent_0.75px)] [background-size:8px_8px] opacity-15" />
            
            {/* Floral embroidery outline drawing */}
            <svg width="70" height="70" viewBox="0 0 100 100" fill="none" stroke="#9c6d68" strokeWidth="1.5">
              ...
              <circle cx="50" cy="35" r="4" fill="#9c6d68" />
            </svg>
            ...
            <div className="absolute top-3 left-1/2 -translate-x-1/2 animate-[needle-bob_1.2s_infinite_ease-in-out]">
              <svg width="8" height="50" viewBox="0 0 10 60" fill="none">
                <ellipse cx="5" cy="15" rx="1.5" ry="5" stroke="#9c6d68" strokeWidth="1" />
                <line x1="5" y1="15" x2="5" y2="55" stroke="#9c6d68" strokeWidth="1.5" />
          ...
          <span className="text-[9px] uppercase tracking-[0.25em] text-[#9c6d68] font-bold mt-4 animate-pulse">Embroidery in Progress...</span>
        </div>
      );
    case 2: // Stitching
      return (
        <div className="relative w-full h-full bg-[#fdfbf7] flex flex-col items-center justify-center p-6 min-h-[250px] md:min-h-0 border-b md:border-b-0 md:border-r border-[#ebdcc6]">
          <div className="relative w-40 h-32 flex items-center justify-center border border-[#ebdcc6] bg-white p-4 shadow-sm rounded-sm overflow-hidden">
            ...
            <div className="absolute bottom-[20px] left-0 right-0 h-3.5 bg-[#9c6d68]/10 border-t border-b border-[#9c6d68]/35 overflow-hidden">
              <div className="w-full h-full border-t border-dashed border-[#9c6d68]/60 animate-[fabric-slide_2s_infinite_linear]" />
            </div>

            {/* Rapid bobbing stitching needle */}
            <div className="absolute bottom-[22px] left-[65px] animate-[needle-bob_0.35s_infinite_linear]">
              <div className="w-[1.5px] h-10 bg-[#9c6d68] relative">
                <div className="absolute bottom-1 w-[2px] h-[2px] bg-[#d4af37] rounded-full" />
              </div>
            </div>
          </div>
          <span className="text-[9px] uppercase tracking-[0.25em] text-[#9c6d68] font-bold mt-4 animate-pulse">Master Tailoring & Assembly...</span>
        </div>
      );
    case 3: // Finishing
      return (
        <div className="relative w-full h-full bg-[#fdfbf7] flex flex-col items-center justify-center p-6 min-h-[250px] md:min-h-0 border-b md:border-b-0 md:border-r border-[#ebdcc6]">
          <div className="relative w-36 h-36 flex items-center justify-center overflow-hidden bg-white border border-[#ebdcc6] rounded-sm">
            <svg width="80" height="100" viewBox="0 0 100 120" fill="none" stroke="#9c6d68" strokeWidth="1.2">
              <path d="M50 15 L50 40 M38 40 L62 40 L65 55 L35 55 Z" />
              <path d="M35 57 L15 105 L85 105 L65 57 Z" />
              <path d="M50 105 L50 115 M35 115 L65 115" stroke="#9c6d68" strokeWidth="1.5" />
            </svg>

            {/* Steamer nozzle and rising steam */}
            <div className="absolute top-8 left-1/2 -translate-x-1/2 flex flex-col items-center">
              <div className="w-6 h-1.5 bg-[#ebdcc6] border border-[#9c6d68] rounded-full" />
          ...
          <span className="text-[9px] uppercase tracking-[0.25em] text-[#9c6d68] font-bold mt-4 animate-pulse">Deep Steam Press & QC Check...</span>
        </div>
      );
    case 4: // Packing
      return (
        <div className="relative w-full h-full bg-[#fdfbf7] flex flex-col items-center justify-center p-6 min-h-[250px] md:min-h-0 border-b md:border-b-0 md:border-r border-[#ebdcc6]">
          <div className="relative w-36 h-36 flex flex-col items-center justify-center bg-white border border-[#ebdcc6] rounded-sm">
            {/* Box trunk */}
            <div className="relative w-24 h-16 border-2 border-[#9c6d68] bg-[#faf6ef] rounded-sm flex items-center justify-center shadow-inner">
              <div className="absolute inset-0.5 border border-dashed border-[#9c6d68]/40 flex items-center justify-center">
                <Gift size={16} className="text-[#9c6d68]/40" />
              </div>
              <div className="absolute top-0 left-0 w-1.5 h-1.5 border-t-2 border-l-2 border-[#9c6d68]" />
              <div className="absolute top-0 right-0 w-1.5 h-1.5 border-t-2 border-r-2 border-[#9c6d68]" />
              <div className="absolute bottom-0 left-0 w-1.5 h-1.5 border-b-2 border-l-2 border-[#9c6d68]" />
              <div className="absolute bottom-0 right-0 w-1.5 h-1.5 border-b-2 border-r-2 border-[#9c6d68]" />
            </div>
            {/* Box lid bobs */}
            <div className="absolute top-[82px] w-24 h-3.5 border border-[#9c6d68] bg-[#faf6ef] rounded-t-sm animate-[box-lid_1.8s_infinite_ease-in-out]" />
          </div>
          <span className="text-[9px] uppercase tracking-[0.25em] text-[#9c6d68] font-bold mt-4 animate-pulse">Signature Keepsake Packing...</span>
        </div>
      );
    case 5: // Shipped
      return (
        <div className="relative w-full h-full bg-[#fdfbf7] flex flex-col items-center justify-center p-6 min-h-[250px] md:min-h-0 border-b md:border-b-0 md:border-r border-[#ebdcc6]">
          <div className="relative w-36 h-36 flex flex-col items-center justify-center bg-white border border-[#ebdcc6] rounded-sm overflow-hidden">
            ...
            <div className="absolute bottom-10 left-0 right-0 h-[1.5px] bg-[#ebdcc6] flex justify-around">
              <div className="w-3 h-full bg-[#9c6d68]/50 animate-[fabric-slide_1.2s_infinite_linear]" />
              <div className="w-3 h-full bg-[#9c6d68]/50 animate-[fabric-slide_1.2s_infinite_linear]" style={{ animationDelay: '0.4s' }} />
              <div className="w-3 h-full bg-[#9c6d68]/50 animate-[fabric-slide_1.2s_infinite_linear]" style={{ animationDelay: '0.8s' }} />
            </div>

            {/* Bouncing delivery truck */}
            <div className="animate-[truck-drive_2s_infinite_ease-in-out]">
              <Truck size={36} className="text-[#9c6d68]" strokeWidth={1.3} />
            </div>
          </div>
          <span className="text-[9px] uppercase tracking-[0.25em] text-[#9c6d68] font-bold mt-4 animate-pulse">On Its Way to You...</span>
        </div>
      );
    default:
      return null;
...
export default function TrackOrderContent() {
  ...
  return (
    <PageShell>
      <div className="min-h-screen bg-[#faf6ef] text-[#1c1813] pt-32 pb-24 px-4 sm:px-6 font-sans selection:bg-[#9c6d68]/25">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <p className="text-[10px] uppercase tracking-[0.4em] text-[#9c6d68] font-bold mb-3">CONCIERGE SERVICES</p>
            <h1 className="font-editorial text-3xl md:text-4xl text-[#1c1813] uppercase tracking-wider">Live Couture Tracker</h1>
            <div className="w-12 h-[1px] bg-[#9c6d68] mx-auto mt-4" />
          </div>

          {/* Search Box */}
          <div className="bg-[#fdfbf7] border border-[#cca09d]/30 p-6 rounded-sm mb-10 shadow-sm">
            <form onSubmit={handleSearchSubmit} className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-grow">
                <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#9c6d68]" size={15} />
                <input
                  required
                  type="text"
                  placeholder="Enter Order ID (e.g. AC-48201)"
                  className="w-full pl-11 pr-4 py-3 text-xs bg-white border border-[#cca09d]/30 text-[#1c1813] placeholder:text-[#1c1813]/40 focus:outline-none focus:border-[#9c6d68] font-semibold tracking-widest uppercase"
                  value={searchId}
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-8 py-3 bg-[#1c1813] text-[#faf6ef] hover:bg-[#9c6d68] hover:text-[#faf6ef] text-[10px] uppercase tracking-[0.3em] font-bold transition-all duration-500 cursor-pointer shadow-sm disabled:opacity-50"
              >
          ...
          {order ? (
            <div className="space-y-8">
              {/* Row 1: Order Summary */}
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 bg-[#fdfbf7] border border-[#cca09d]/20 p-6 rounded-sm shadow-sm">
                <div className="md:col-span-4 flex items-center gap-4">
                  <div className="w-20 h-24 bg-white border border-[#cca09d]/15 overflow-hidden shrink-0">
                    <img
                  ...
                  <div>
                    ...
                    <p className="text-[10px] uppercase tracking-wider text-[#9c6d68] mt-1 font-semibold">Size: {order.item.size} | Qty: {order.item.quantity}</p>
                    <p className="text-xs font-bold text-[#1c1813]/80 mt-1">{order.item.price}</p>
                  </div>
                </div>

                <div className="md:col-span-4 border-t md:border-t-0 md:border-l border-[#cca09d]/10 pt-4 md:pt-0 md:pl-6 space-y-2">
                  <p className="text-[8.5px] uppercase tracking-widest text-[#9c6d68] font-bold">Shipping Destination</p>
                ...
                <div className="md:col-span-4 border-t md:border-t-0 md:border-l border-[#cca09d]/10 pt-4 md:pt-0 md:pl-6 space-y-2 flex flex-col justify-between">
                  <div>
                    <p className="text-[8.5px] uppercase tracking-widest text-[#9c6d68] font-bold">Transaction Details</p>
                    <div className="flex items-center gap-2 mt-1.5">
                      <CreditCard size={12} className="text-[#9c6d68]" />
                      <span className="text-[10px] tracking-wider text-[#1c1813]/80 font-bold">{order.payment.method} ({order.payment.status})</span>
                    </div>
                  </div>
                  <div className="pt-2">
                    <span className="text-[8.5px] uppercase tracking-widest text-[#9c6d68] block font-bold">Order ID</span>
              ...
              {isLehenga ? (
                <div className="bg-[#fdfaf4] border border-[#ebdcc6] rounded-sm p-6 md:p-10 space-y-10 relative overflow-hidden shadow-sm">
                        ...
                        return (
                          <React.Fragment key={idx}>
                            <div className="flex flex-col items-center text-center">
                              ...
                              <div 
                                className={`w-12 h-12 rounded-full border flex items-center justify-center transition-all duration-700 ${
                                  isCompleted || isActive
                                    ? "bg-white border-[#9c6d68] text-[#9c6d68] shadow-[0_0_10px_rgba(170,151,117,0.15)]"
                              ...
                              {/* Labels */}
                              <span className={`text-[9.5px] uppercase tracking-widest font-bold block mt-3 ${isCompleted || isActive ? "text-[#9c6d68]" : "text-[#1c1813]/40"}`}>
                                {stage.title}
                              </span>
                              <span className={`text-[9px] font-medium block mt-0.5 ${isActive ? "text-[#9c6d68] font-bold" : "text-[#1c1813]/45"}`}>
                            ...
                            {idx < lehengaStages.length - 1 && (
                              <div className="flex-grow h-[1px] relative mx-2 bg-[#ebdcc6]">
                                <div 
                                  className="h-full bg-[#9c6d68] transition-all duration-1000 origin-left"
                                  style={{ width: idx < journey.stageIndex ? "100%" : idx === journey.stageIndex ? "50%" : "0%" }}
                                />
                                {idx === journey.stageIndex && (
                                  <div 
                                    className="absolute top-1/2 -translate-y-1/2 w-1.5 h-1.5 border-t border-r border-[#9c6d68] rotate-45 transition-all duration-1000"
                                    style={{ left: "50%" }}
                                  />
                                )}
                              </div>
                  ...
                  <div className="border border-[#ebdcc6] rounded-sm bg-white overflow-hidden flex flex-col md:flex-row shadow-sm">
                    ...
                    <div className="w-full md:w-[50%] aspect-video md:aspect-auto md:min-h-[300px] overflow-hidden relative flex">
                      ...
                      <button 
                        ...
                        className="absolute bottom-3 right-3 bg-white/95 border border-[#ebdcc6] hover:bg-[#faf6ef] text-[#9c6d68] text-[8.5px] uppercase tracking-widest font-bold px-3 py-1.5 rounded-sm shadow-md transition-all flex items-center gap-1.5 z-20 cursor-pointer"
                      >
                        {showAnimation ? (
                          <>
                    ...
                    <div className="p-6 md:p-8 flex-grow flex flex-col justify-center">
                      <span className="text-[8.5px] uppercase tracking-[0.25em] text-[#9c6d68]/80 font-bold block mb-1">Current Status</span>
                      <h3 className="font-editorial text-2xl text-[#9c6d68] uppercase tracking-wider font-semibold">
                        {lehengaStages[journey.stageIndex].title} in Progress
                      </h3>
                      
                      <div className="w-10 h-[1.5px] bg-[#9c6d68]/40 my-3" />
                      ...
                      <div className="flex items-center gap-4">
                        <div className="h-1.5 bg-[#ebdcc6]/50 rounded-full flex-grow overflow-hidden">
                          <div 
                            className="h-full bg-[#9c6d68] rounded-full transition-all duration-1000"
                            style={{ width: `${journey.percentage}%` }}
                          />
                        </div>
                        <span className="text-[10px] font-bold text-[#9c6d68] shrink-0">{journey.percentage}% Completed</span>
                      </div>

                      {/* Infobox */}
                      <div className="bg-[#fcfaf7] border border-[#ebdcc6]/50 p-3.5 rounded-sm flex items-center gap-3.5 mt-5">
                        <div className="w-8 h-8 rounded-full bg-[#9c6d68]/5 flex items-center justify-center text-[#9c6d68] shrink-0">
                          <Heart size={14} className="fill-[#9c6d68]/10" strokeWidth={1.5} />
                        </div>
                        <div>
                  ...
                  <div className="border border-[#ebdcc6] bg-white rounded-sm p-4 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
                    <div className="flex items-center gap-3.5">
                      <Calendar size={18} className="text-[#9c6d68]" strokeWidth={1.5} />
                      <div>
                        <span className="text-[8.5px] uppercase tracking-wider text-[#9c6d68] block font-bold">Estimated Completion</span>
                    ...
                    <div className="flex items-center gap-3.5">
                      <Mail size={18} className="text-[#9c6d68]" strokeWidth={1.5} />
                      <div>
                  ...
                  <div className="text-center pt-2">
                    <p className="text-[9px] uppercase tracking-[0.3em] font-bold text-[#9c6d68] flex items-center justify-center gap-1.5">
                  ...
                  <div className="bg-[#fdfbf7] border border-[#9c6d68]/20 p-4 rounded-sm relative mt-4">
                    <div className="absolute top-0 left-0 w-2 h-2 border-t border-l border-[#9c6d68]/40" />
                    <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-[#9c6d68]/40" />
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      <div>
                        <span className="text-[8.5px] uppercase tracking-[0.25em] text-[#9c6d68] font-bold block mb-1">Couture Journey Simulator</span>
                      ...
                      {simulatedDays !== null && (
                        <button 
                          ...
                          className="px-3 py-1 bg-[#9c6d68]/10 hover:bg-[#9c6d68]/20 text-[#9c6d68] border border-[#9c6d68]/35 text-[8.5px] uppercase tracking-widest font-bold transition-all rounded-sm shrink-0 cursor-pointer font-sans"
                        >
                          Reset Real Time
                        </button>
                      )}
                    ...
                    <div className="flex items-center gap-4 mt-3.5 w-full">
                      <span className="text-[9px] uppercase font-bold text-[#9c6d68] shrink-0">Day 1</span>
                      <input 
                        type="range"
                        min="1"
                        max="40"
                        ...
                        className="w-full h-1 bg-[#9c6d68]/25 appearance-none cursor-pointer rounded-full accent-[#9c6d68] focus:outline-none"
                      />
                      <span className="text-[9px] uppercase font-bold text-[#9c6d68] shrink-0">Day 40</span>
                    </div>
                    <p className="text-center text-[9px] uppercase tracking-widest font-bold text-[#9c6d68] mt-2">
                ...
                <div className="bg-[#fdfbf7] border border-[#cca09d]/20 p-6 md:p-8 rounded-sm shadow-sm">
                  <h2 className="text-xs uppercase tracking-[0.3em] text-[#9c6d68] font-bold mb-8 flex items-center gap-2">
                    <Compass size={14} className="animate-spin" />
                    Couture Timeline
                  </h2>
                  
                  <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-4">
                    <div className="absolute left-[15px] md:left-0 top-0 md:top-[15px] h-full md:h-[2px] w-[2px] md:w-full bg-[#cca09d]/15 -z-10" />
                    <div 
                      className="absolute left-[15px] md:left-0 top-0 md:top-[15px] h-full md:h-[2px] w-[2px] md:w-full bg-[#9c6d68] transition-all duration-1000 origin-top md:origin-left -z-10" 
                      style={{
                        transform: `scaleX(${
                        ...
                        <div key={idx} className="flex md:flex-col items-center md:text-center gap-4 md:gap-3 flex-1 w-full">
                          <div 
                            className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all duration-500 shrink-0 ${
                              isCompleted 
                                ? "bg-[#9c6d68] border-[#9c6d68] text-[#1c1813]" 
                                : "bg-white border-[#cca09d]/30 text-[#cca09d]/45"
                            } ${isActive ? "shadow-[0_0_15px_rgba(170,151,117,0.25)] animate-pulse border-[#9c6d68]" : ""}`}
                          >
                            <Icon size={14} />
                          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                <div className="md:col-span-8 bg-[#fdfbf7] border border-[#cca09d]/20 p-5 rounded-sm flex flex-col justify-between overflow-hidden shadow-sm">
                  <h3 className="text-[10px] uppercase tracking-[0.35em] text-[#9c6d68] font-bold mb-4 flex items-center gap-2">
                    <span className="w-2.5 h-2.5 bg-[#9c6d68] rounded-full inline-block animate-ping" />
                  ...
                  <div className="w-full aspect-[16/9] border border-[#ebdcc6] rounded-sm bg-[#faf6ef]/50 flex items-center justify-center relative">
                    {order.status === "Shipped" || order.status === "Out for Delivery" || order.status === "Delivered" ? (
                      ...
                      <div className="p-6 text-center space-y-3.5 max-w-sm">
                        <Compass size={28} className="text-[#9c6d68]/50 mx-auto animate-pulse" />
                        ...
                        <span className="inline-block text-[8px] uppercase tracking-widest px-2.5 py-1 bg-[#9c6d68]/10 text-[#9c6d68] border border-[#9c6d68]/20 font-bold rounded-sm mt-1">
                ...
                <div className="md:col-span-4 bg-[#fdfbf7] border border-[#cca09d]/20 p-6 rounded-sm flex flex-col justify-between shadow-sm">
                  <div className="space-y-6">
                    <h3 className="text-[10px] uppercase tracking-[0.3em] text-[#9c6d68] font-bold">Transit Status</h3>
                    
                    <div className="space-y-4">
                      <div>
                        <span className="text-[8px] uppercase tracking-widest text-[#9c6d68] block font-bold">Current Location</span>
                        <strong className="text-sm text-[#1c1813] tracking-wider block mt-0.5 uppercase font-mono">{order.location}</strong>
                      </div>
                      
                      <div>
                        <span className="text-[8px] uppercase tracking-widest text-[#9c6d68] block font-bold">Transit Milestone</span>
                  ...
                  <div className="pt-6 border-t border-[#cca09d]/10 mt-6 space-y-3">
                    ...
                    <a
                      ...
                      className="w-full py-2.5 border border-[#9c6d68]/50 hover:border-[#9c6d68] text-[#9c6d68] hover:bg-[#9c6d68]/5 text-[8.5px] uppercase tracking-[0.25em] font-bold transition-all duration-300 text-center inline-block cursor-pointer"
                    >
            ...
            <div className="text-center py-16 bg-[#fdfbf7] border border-[#cca09d]/25 rounded-sm shadow-sm">
              <Compass size={40} className="text-[#9c6d68]/45 mx-auto mb-4 animate-pulse" />
