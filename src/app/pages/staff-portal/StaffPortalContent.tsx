    ...
    return (
      <PageShell>
        <div className="min-h-screen bg-[#1c1813] text-[#f5ebd9] flex items-center justify-center pt-32 pb-24 px-4">
          <div className="w-full max-w-md bg-[#2c1619] border border-[#d59f9b]/30 p-8 rounded-sm shadow-2xl relative">
            {/* Corner styling */}
            <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-[#d59f9b]" />
            <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-[#d59f9b]" />
            <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-[#d59f9b]" />
            <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-[#d59f9b]" />

            <div className="text-center mb-8">
              <div className="w-12 h-12 rounded-full border border-[#d59f9b]/45 flex items-center justify-center mx-auto mb-4 bg-[#d59f9b]/5 shadow-[0_0_15px_rgba(212,175,55,0.1)]">
                <Lock className="text-[#d59f9b]" size={20} />
              </div>
              <h2 className="font-editorial text-2xl tracking-wider text-[#f5ebd9] uppercase font-bold">Atelier Staff Portal</h2>
              <p className="text-[9px] uppercase tracking-[0.25em] text-[#d59f9b]/80 mt-1 font-semibold">Authorized Personnel Only</p>
            </div>

            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                <label className="text-[8px] uppercase tracking-[0.3em] text-[#9c6d68] font-bold block mb-1.5">Username</label>
                <div className="relative">
                  <User className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#9c6d68]" size={14} />
                  <input
                    required
                    type="text"
                    placeholder="Enter Staff Username"
                    className="w-full pl-10 pr-4 py-2.5 text-xs bg-[#1c0d0e]/80 border border-[#cca09d]/30 text-[#f5ebd9] placeholder:text-[#f5ebd9]/35 focus:outline-none focus:border-[#d59f9b] font-semibold tracking-wider"
                    value={username}
              ...
              <div>
                <label className="text-[8px] uppercase tracking-[0.3em] text-[#9c6d68] font-bold block mb-1.5">Password</label>
                <div className="relative">
                  <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#9c6d68]" size={14} />
                  <input
                    required
                    type="password"
              ...
              <button
                type="submit"
                className="w-full py-3.5 bg-[#9c6d68] text-[#1c1813] hover:bg-[#f5ebd9] hover:text-[#1c1813] text-[9.5px] uppercase tracking-[0.4em] font-bold transition-all duration-500 cursor-pointer shadow-lg mt-6"
              >
                Access Dashboard
              </button>
            </form>
    ...
    <PageShell>
      <div className="min-h-screen bg-[#1c1813] text-[#f5ebd9] pt-32 pb-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          {notification && (
            <div className="bg-[#9c6d68] text-[#1c1813] border border-[#d59f9b] p-4 rounded-sm flex items-center justify-between shadow-2xl animate-bounce">
          ...
          {/* Header */}
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6 border-b border-[#cca09d]/20">
            <div>
              <p className="text-[10px] uppercase tracking-[0.4em] text-[#9c6d68] font-bold">COUTURE STUDIO MANAGEMENT</p>
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={fetchOrders}
                disabled={loading}
                className="px-5 py-2.5 border border-[#9c6d68]/40 hover:border-[#9c6d68] text-[#9c6d68] text-[9.5px] uppercase tracking-[0.2em] font-bold transition-all duration-300 flex items-center gap-2 cursor-pointer"
              >
                <Database size={12} />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-[#1c0d0e]/20 border border-[#cca09d]/15 p-4 rounded-sm">
              <span className="text-[8px] uppercase tracking-widest text-[#9c6d68] block font-bold">Total Couture Orders</span>
              <strong className="text-xl font-bold tracking-widest text-[#f5ebd9] font-mono block mt-1">{orders.length}</strong>
            </div>
            <div className="bg-[#1c0d0e]/20 border border-[#cca09d]/15 p-4 rounded-sm">
              <span className="text-[8px] uppercase tracking-widest text-[#9c6d68] block font-bold">In Tailoring / Crafting</span>
            ...
            <div className="bg-[#1c0d0e]/20 border border-[#cca09d]/15 p-4 rounded-sm">
              <span className="text-[8px] uppercase tracking-widest text-[#9c6d68] block font-bold">Dispatched / Shipped</span>
              <strong className="text-xl font-bold tracking-widest text-[#f5ebd9] font-mono block mt-1">
                {orders.filter(o => o.status === "Shipped").length}
              </strong>
            </div>
            <div className="bg-[#1c0d0e]/20 border border-[#cca09d]/15 p-4 rounded-sm">
              <span className="text-[8px] uppercase tracking-widest text-[#9c6d68] block font-bold">Delivered Completed</span>
              <strong className="text-xl font-bold tracking-widest text-[#f5ebd9] font-mono block mt-1">
          ...
          <div className="space-y-6">
            <h2 className="text-xs uppercase tracking-[0.3em] text-[#9c6d68] font-bold flex items-center gap-2">
              <ClipboardList size={14} />
              Bespoke Order Registry
            </h2>

            {orders.length === 0 ? (
              <div className="text-center py-16 bg-[#1c0d0e]/10 border border-[#cca09d]/10 rounded-sm">
              ...
              <div className="space-y-6">
                {orders.map((o) => (
                  <div 
                    key={o.id}
                    id={o.id}
                    className="bg-[#1c0d0e]/35 border border-[#cca09d]/20 rounded-sm p-6 relative overflow-hidden transition-all duration-300 hover:border-[#9c6d68]"
                  >
                    {/* Unique Highlight for Confirmed step */}
                    {o.status === "Confirmed" && (
                      <div className="absolute top-0 right-0 bg-[#9c6d68] text-[#1c1813] text-[7.5px] uppercase tracking-widest font-bold px-3 py-1 rounded-bl-sm">
                        New Order
                      </div>
                    )}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                      ...
                      <div className="lg:col-span-3 flex items-center gap-4">
                        <div className="w-16 h-20 bg-[#1c1813] border border-[#cca09d]/15 overflow-hidden shrink-0">
                          <img
                            src={o.item.imageUrl}
                            alt={o.item.name}
                        ...
                        <div>
                          <span className="text-[8px] uppercase tracking-widest text-[#9c6d68] block font-mono font-bold">{o.id}</span>
                          ...
                          <p className="text-[9.5px] text-[#9c6d68]/90 font-bold mt-1">{o.item.price}</p>
                        </div>
                      </div>

                      {/* Middle Left: Customer Details */}
                      <div className="lg:col-span-4 border-t lg:border-t-0 lg:border-l border-[#cca09d]/10 pt-4 lg:pt-0 lg:pl-6 space-y-1">
                        <span className="text-[8.5px] uppercase tracking-widest text-[#9c6d68] block font-bold">Delivery Address</span>
                        ...
                        {o.customer.note && (
                          <div className="bg-[#2d123e]/50 border border-[#cca09d]/10 p-2 rounded-sm mt-2 text-[9px] text-[#9c6d68] leading-relaxed italic font-medium">
                      ...
                      <div className="lg:col-span-2 border-t lg:border-t-0 lg:border-l border-[#cca09d]/10 pt-4 lg:pt-0 lg:pl-6 space-y-2">
                        <div>
                          <span className="text-[8.5px] uppercase tracking-widest text-[#9c6d68] block font-bold font-semibold">Payment</span>
                      ...
                      <div className="lg:col-span-3 border-t lg:border-t-0 lg:border-l border-[#cca09d]/10 pt-4 lg:pt-0 lg:pl-6 space-y-4">
                        <span className="text-[8.5px] uppercase tracking-widest text-[#9c6d68] block font-bold">Transit Controls</span>
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <select
                              className="w-full bg-[#1c1813] border border-[#cca09d]/30 text-xs px-2.5 py-1.5 text-[#f5ebd9] focus:outline-none focus:border-[#9c6d68] font-semibold"
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <MapPin className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[#9c6d68]" size={11} />
                              <input
                                type="text"
                                className="w-full bg-[#1c1813] border border-[#cca09d]/30 text-xs pl-8 pr-2 py-1.5 text-[#f5ebd9] focus:outline-none focus:border-[#9c6d68] font-semibold tracking-wide"
                          ...
                          <button
                            ...
                            className="w-full py-2 bg-[#9c6d68] text-[#1c1813] hover:bg-[#f5ebd9] hover:text-[#1c1813] text-[9px] uppercase tracking-wider font-bold transition-all duration-300 cursor-pointer shadow-md disabled:opacity-50"
                          >
